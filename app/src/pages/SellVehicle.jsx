    ...
    try {
      ...
      Object.entries(form).forEach(([key, value]) => {
        if (key === "images") {
          ...
          (key === "fcDuration" || key === "fcUnit") &&
          form.fc !== "Yes"
        ) {
          // skip if fc is not Yes
        } else if (
          (key === "insuranceDuration" || key === "insuranceUnit") &&
          form.insurance !== "Yes"
        ) {
          // skip if insurance is not Yes
        } else {
              ...
              >
                ...
                <div className="form-row" style={{ display: "flex", gap: 18 }}>
                  <div className="form-group" style={{ flex: 1 }}>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      placeholder="e.g. 2018 Maruti Swift VXI, Single Owner"
                      maxLength={70}
                      style={{
                        width: "100%",
                        borderRadius: 12,
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    background:
                      "linear-gradient(90deg, #1e3a8a 60%, #3b82f6 100%)",
                    color: "#fff",
                    fontWeight: 700,
                    fontSize: 20,
                    borderRadius: 14,
                  ...
                  onMouseOver={(e) =>
                    (e.currentTarget.style.background =
                      "linear-gradient(90deg, #3b82f6 60%, #1e3a8a 100%)")
                  }
                  onMouseOut={(e) =>
                    (e.currentTarget.style.background =
                      "linear-gradient(90deg, #1e3a8a 60%, #3b82f6 100%)")
